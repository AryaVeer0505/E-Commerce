  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-ful items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} type="text" placeholder='Type here' required className='w-full max-w-[550px] px-3 py-2'/>
      </div>
      <div className='w-full'>
        <p className='mb-2'>Product Description</p>
       <textarea onChange={(e)=>setDescription(e.target.value)} value={description} name="" id="" placeholder='Write content here'className='w-full max-w-[550px] px-3 py-2'></textarea>
      </div>
