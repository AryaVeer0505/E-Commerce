      ...
      <div className='mt-8 '>
            ...
            <div className='mt-12'>
              <Title text1={'PAYMENT'} text2={"MODE"}/>
                ...
                <div className='w-full tetx-end mt-8'>
                   <button type='submit' className='bg-black text-white text-sm py-2 px-3 rounded '>Place Order</button>
                </div>
            </div>
      </div>
    </form>
